...
public class Cuboid {
    ...
    public Iterator<Location> corners() {
        List<Location> bL = new ArrayList<>(4);
        bL.add(new Location(this.world, this.xMin, this.yMin, this.zMin));
        bL.add(new Location(this.world, this.xMin, this.yMin, this.zMax));
        bL.add(new Location(this.world, this.xMax, this.yMin, this.zMin));
        bL.add(new Location(this.world, this.xMax, this.yMin, this.zMax));
        return bL.iterator();
    }
    ...
    public boolean intersects(Cuboid other) {
        // Check if the cuboids are in the same world
        ...
        // If there is overlap in both X and Z dimensions, the cuboids intersect on the XZ plane
